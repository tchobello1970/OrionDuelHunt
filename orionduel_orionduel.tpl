...
<div id="resized_id">
       <div id="player_board_id" class="board">
           <div id="eridanus_id" class="constel"></div>
           <div id="canis_major_id" class="constel"></div>
           <div id="taurus_id" class="constel"></div>
           <div id="monoceros_id" class="constel"></div>
           <div id="lepus_id" class="constel"></div>
           <div id="gemini_id" class="constel"></div>
       </div>

</div>

<script type="text/javascript">
    const jstpl_hex = '<div id="hex_${id}" class="hex ${class}" style="top: ${top}px; left: ${left}px;"></div>';
    ...
    const jstpl_tile_in_hand = '<div id="text_container_${id}" class="text_container ${inverted}" style="top: ${top}px; left: ${left}px;"><span class="piece_number">x </span><span id="${id}" class="piece_number">${nb}</span></div>';

var jstpl_player_board = '<div class="ai_board" id="ai_board_${id}" ></div>';
var jstpl_how_to_win = '<div class="how_to_win_marker" id="how_to_win_id" ></div>';

var jstpl_show_infos = '<div id="help-mode-switch">\
        <input type="checkbox" class="checkbox" id="help-mode-chk" />\
        <label class="label" for="help-mode-chk"><div class="ball"></div></label>\
